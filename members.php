	...
	<body>
			<?php
				...
				if ($num_rows == 0) {
					...
					echo '<th>Credit</th>';
					echo '<th>Paid Membership Fee on:</th>';
					echo '<th>Username for Login</th>';
					echo '<th>Update</th>';
					echo '</tr>';
					echo '</thead>';
					...
					while ($row = mysqli_fetch_array($result,MYSQL_ASSOC)) {
						...
						echo '<td>'.'<a href="editmember.php?id='.$row['CustomerID'].'">Edit member details</a>'.'</td>'; //Adds link to update fields
						echo '</tr>';
					}
					echo '</tbody>';
