...
<body>
    ...
    <?php
		...
		if (!empty($_POST)) {
			...
			$privatekey = "6Le6FuMSAAAAAP5U6gyFAIPy2dSXDdZLLSU9uo98";
			...
			if (!($resp->is_valid)) {
				...
				echo "The reCAPTCHA wasn't entered correctly." . "(reCAPTCHA said: " . $resp->error . ")";
			} else {
				$_SESSION['Token'] = md5 (rand());
				echo '<p>Your identity has been verified</p>';
				echo '<a href="/toylib/reservation.php?'. SID .'">Go to Email Form</a>';
				include 'base/copyright.php';
				exit;
			}
		}
	?>
    	...
    	<form name="emailform" action="notspam.php" method="post">
        	<p>Enter the words you see:<p>
				<?php
                    require_once('recaptchalib.php');
                    $publickey = "6Le6FuMSAAAAAP0tPRSa1dIX7ytgaVNEckqUkXe3";
                    echo recaptcha_get_html($publickey);
					echo '<br>';
                ?>
     	<input type="submit" name="send" value="Verify my Identity" /></td>
		</form>
